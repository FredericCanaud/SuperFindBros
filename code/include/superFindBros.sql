...
CREATE TABLE IF NOT EXISTS `super_find_bros`.`personne` (
  ...
  `per_admin` BOOLEAN NOT NULL,
  PRIMARY KEY (`per_num`))
ENGINE = InnoDB;

INSERT INTO `personne` (`per_num`, `per_prenom`, `per_nom`, `per_age`, `per_mail`, `per_pseudo`, `per_mdp`, `per_avatar`, `per_admin`) VALUES
(1,'Caroline','Diamant',26,'caroline@gmail.com','caroLaBoss','f1ddfc6dc0d8a0efbf1f03c4f7c7679eb45a7002','1.jpg', FALSE),
(2,'Roger','Sanchez',42,'roger@gmail.com','rogerLaBoss','b79daf85e1ac6328c8d038f56b36cd738def2daa','2.jpg', FALSE),
(3,'Emmanuel','Moman',31,'moman@gmail.com','momanus','5b13bf52015603d3af7b450dd2f8daefded88c08','3.jpg', FALSE),
(4,'Delphine','Belle',24,'delphine@xnxx.com','belleDelphine','0b07b07cea5bcd7d6d411e7bd683282ce8bd996a','4.jpg', FALSE),
(5,'Timeo','Dupond',7,'timeo@hotmail.fr','XxDarkSasukexX','33f842745fe47b771aa51c89206666de11ed34a8','5.jpg', FALSE),
(6,'Manon','Dessources',21,'manon@gmail.com','superManon','316555c8cadb8a55e6108eb60ae6e28dbe63194e','6.jpg', FALSE),
(7,'Xavier','Dang',40,'mistermv@lefigaro.fr','mistermv','ce76adfc5ae41ff34edc3f1999672665b9e4ee45','7.png', FALSE),
(8,'Admin','admin',99,'admin@admin.fr','Admin','99cf22cf484c8f21df160dedabb0f129325dd6ea','admin.png', TRUE);
